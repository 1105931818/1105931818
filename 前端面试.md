...
```js
console.log(a) // let 会报错  var  undefined
...
![image-20210305165413588](前端面试手册.assets/image-20210305165413588.png)
...
![image-20210305165848781](前端面试手册.assets/image-20210305165848781.png)
...
![image-20210305172448582](前端面试手册.assets/image-20210305172448582.png)
...
![image-20210306093300970](前端面试手册.assets/image-20210306093300970.png)
...
![image-20210306104516852](前端面试手册.assets/image-20210306104516852.png)
...
![image-20210306111112493](前端面试手册.assets/image-20210306111112493.png)
...
// 2. 定义Student构造函数
function Student (name, age, className) {
  Person.call(this, name, age) // 实现构造属性的继承  // 子构造函数, 借用父构造函数进行实例化
  this.className = className
}
...
![image-20210306114638139](前端面试手册.assets/image-20210306114638139.png)
...
function isArray(arg) {
    // 用最顶层的 Object.prototype 的 toString 方法进行调用
    // 返回格式 [object 类型]
...
![image-20210306144638905](前端面试手册.assets/image-20210306144638905.png)
...
![image-20201208040306978](前端面试手册.assets/image-20201208040306978.png)

**事件循环队列 eventLoop**

![image-20201208040235602](前端面试手册.assets/image-20201208040235602.png)
...
![image-20210306151137688](前端面试手册.assets/image-20210306151137688.png)
...
![image-20210306152010989](前端面试手册.assets/image-20210306152010989.png)
...
```js
Reflect.ownkeys(obj).length === 0 //返回所有属性，包括不可枚举类型（Symbol)
Object.keys(obj).length === 0 //返回所有属性，不包括不可枚举类型
Object.getOwnPropertyNames(obj) === 0 //返回所有属性，不包括不可枚举类型
...
![image-20210305232854139](前端面试手册.assets/image-20210305232854139.png)
...
![image-20210306161216371](前端面试手册.assets/image-20210306161216371.png)
...
![image-20210306005550796](前端面试手册.assets/image-20210306005550796.png)
...
![image-20210306011528361](前端面试手册.assets/image-20210306011528361.png)
...
![image-20210308102015595](前端面试手册.assets/image-20210308102015595.png)
...
![image-20210306014409595](前端面试手册.assets/image-20210306014409595.png)



当公司申请了 CA 证书后, 就应该在响应时, 将数字证书一起发送给客户端

![image-20210306021013686](前端面试手册.assets/image-20210306021013686.png)
...
2. 如果签发证书的机构, 不权威, 发出警告 
   ...
   ![image-20210306021532010](前端面试手册.assets/image-20210306021532010.png)
...
![image-20210306023912779](前端面试手册.assets/image-20210306023912779.png)
...
![img](前端面试手册.assets/940884-20180423141536107-329179455.png)
...
![image-20210308182724715](前端面试手册.assets/image-20210308182724715.png)
...
1. **max-age** 指定一个时间长度，在这个时间段内缓存是有效的，单位是s。
   ...
   ![image-20210308182737673](前端面试手册.assets/image-20210308182737673.png)
...
![image-20210308182821236](前端面试手册.assets/image-20210308182821236.png)

当浏览器再次请求该资源时(进行协商请求时)，发送的请求头中会包含If-Modify-Since，**该值为缓存之前返回的Last-Modify**。

服务器收到If-Modify-Since后，根据实际服务器的资源的最后修改时间, 进行判断是否命中缓存。

![img](前端面试手册.assets/940884-20180423141732879-1484228353.png)

如果命中缓存，则返回 **http304**，并且不会返回资源内容，并且不会返回Last-Modify。

![image-20210308123308326](前端面试手册.assets/image-20210308123308326.png)
...
![image-20210308182858733](前端面试手册.assets/image-20210308182858733.png)
...
![image-20210308182913833](前端面试手册.assets/image-20210308182913833.png)

**浏览器第二次请求**

![image-20210308182925144](前端面试手册.assets/image-20210308182925144.png)
...
![dns域名解析](前端面试手册.assets/5rxqugj8dh.png)
...
![image-20220422181815532](./前端面试手册.assets/image-20220422181815532.png)
...
![image-20201209162908979](前端面试手册.assets/image-20201209162908979.png)
...
![image-20210309091528931](前端面试手册.assets/image-20210309091528931.png)
...
![image-20210309092038850](前端面试手册.assets/image-20210309092038850.png)
...
![image-20210309092558579](前端面试手册.assets/image-20210309092558579.png)
...
2. 生产环境的跨域问题 (使用 nginx 服务器代理)
   ...
   ![image-20210308005644520](前端面试手册.assets/image-20210308005644520.png)
...
![image-20210309110119416](前端面试手册.assets/image-20210309110119416.png)



![image-20210309112949579](前端面试手册.assets/image-20210309112949579.png)
...
![image-20210309011422081](前端面试手册.assets/image-20210309011422081.png)
...
![image-20210309122823432](前端面试手册.assets/image-20210309122823432.png)
...
![image-20201208122803496](前端面试手册.assets/image-20201208122803496.png)



![image-20210309151257119](前端面试手册.assets/image-20210309151257119.png)
...
![image-20210309155633728](前端面试手册.assets/image-20210309155633728.png)
...
4. 使用Phantomjs `针对爬虫` 做处理
   ...
   ![image-20210309024213922](前端面试手册.assets/image-20210309024213922.png)
...
3. 剩下的菜单权限控制，是相对复杂一些的
   ...
   ![image-20210309031043592](前端面试手册.assets/image-20210309031043592.png)
...
![image-20210309032653781](前端面试手册.assets/image-20210309032653781.png)



微信支付：需要自己根据后台返回的url生成二维码页面，如图所示

![image-20210309032629631](前端面试手册.assets/image-20210309032629631.png)
...
![image-20210309172322244](前端面试手册.assets/image-20210309172322244.png)
...
![image-20210309034800953](前端面试手册.assets/image-20210309034800953.png)
